  ...
  <div class="min-h-screen">
    ...
    <div class="flex flex-row h-[calc(100vh-74px)]">
      ...
      <div class="flex flex-col w-1/3 bg-white h-full">
        ...
        <div class="scrollbar-w-none h-full min-h-0 px-6 py-7 overflow-x-hidden overflow-y-scroll">
          <!-- 人类消息 -->
          <div v-for="message in messages" :key="message.content" class="flex flex-row gap-2 mb-6">
            ...
            <div class="flex flex-col gap-2">
              <div class="font-semibold text-gray-700">
                {{ message.role === 'human' ? 'XXM' : 'ChatGPT机器人' }}
              </div>
              <div
                v-if="message.role === 'human'"
          ...
          >
            <a-avatar :style="{ backgroundColor: '#00d0b6' }" shape="square" :size="70">
              <icon-apps></icon-apps>
            </a-avatar>
...
const debug = async () => {
  const res = await post('/apps/468d0bff-9c74-4762-9635-1a8dde3941ca/debug', {
    body: { query: '你好，你是谁' },
  })
